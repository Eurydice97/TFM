...
for(i in 1:nb_trials) {
  for(j in 1:nb_series) {
    NRMSE = nrmse(preds_nn[[i]][[j]]$yh[1:nb_time_steps], preds_nn[[i]][[j]]$Y[1:nb_time_steps], na.rm=TRUE, norm="maxmin")
    NRMSEs_nn[i, j] = NRMSE
  }
}
...
for(i in 1:nb_trials) {
  for(j in 1:nb_series) {
    NRMSE = nrmse(preds_n005[[i]][[j]]$yh[1:nb_time_steps], preds_n005[[i]][[j]]$Y[1:nb_time_steps], na.rm=TRUE, norm="maxmin")
...
for(i in 1:nb_trials) {
  for(j in 1:nb_series) {
    NRMSE = nrmse(as.vector(preds_n005[[i]][[j]]$yh_smooth[1:nb_time_steps]), preds_n005[[i]][[j]]$Y[1:nb_time_steps], na.rm=TRUE, norm="maxmin")
...
for(i in 1:nb_trials) {
  for(j in 1:nb_series) {
    NRMSE = nrmse(preds_n01[[i]][[j]]$yh[1:nb_time_steps], preds_n01[[i]][[j]]$Y[1:nb_time_steps], na.rm=TRUE, norm="maxmin")
...
for(i in 1:nb_trials) {
  for(j in 1:nb_series) {
    NRMSE = nrmse(as.vector(preds_n01[[i]][[j]]$yh_smooth[1:nb_time_steps]), preds_n01[[i]][[j]]$Y[1:nb_time_steps], na.rm=TRUE, norm="maxmin")
...
for(i in 1:nb_trials) {
  for(j in 1:nb_series) {
    NRMSE = nrmse(preds_n02[[i]][[j]]$yh[1:nb_time_steps], preds_n02[[i]][[j]]$Y[1:nb_time_steps], na.rm=TRUE, norm="maxmin")
...
for(i in 1:nb_trials) {
  for(j in 1:nb_series) {
    NRMSE = nrmse(as.vector(preds_n02[[i]][[j]]$yh_smooth)[1:nb_time_steps], preds_n02[[i]][[j]]$Y[1:nb_time_steps], na.rm=TRUE, norm="maxmin")
