...
for(j in 1:(nb_series)) {
  ...
  df_real = data.frame(time = seq(1,100,length=100), Coordinate = preds_nn[[1]][[j]]$Y[1:100], 
                       Label = "Real")
  df_pred = data.frame(time = seq(1,100,length=100), Coordinate = preds_nn[[1]][[j]]$yh[1:100], 
                       Label = "Predicted")
...
for(i in 1:nb_trials) {
  for(j in 1:nb_series) {
    NRMSE = nrmse(preds_n005[[i]][[j]]$yh, preds_n005[[i]][[j]]$Y, na.rm=TRUE, norm="sd")
...
names(NRMSEs_n005) = c('Cl', 'Cd', 'index')
...
names(NRMSEs_n005_smooth) = c('Cl', 'Cd', 'index')
...
for(j in 1:(nb_series)) {
  ...
  df_real = data.frame(time = seq(1,100,length=100), Coordinate = preds_n005[[300]][[j]]$Y[1:100],
                       Label = "Real")
  df_pred = data.frame(time = seq(1,100,length=100), Coordinate = preds_n005[[300]][[j]]$yh_smooth[1:100],
                       Label = "Predicted")
...
for(i in 1:nb_trials) {
  for(j in 1:nb_series) {
    NRMSE = nrmse(preds_n01[[i]][[j]]$yh, preds_n01[[i]][[j]]$Y, na.rm=TRUE, norm="sd")
...
names(NRMSEs_n01) = c('Cl', 'Cd', 'index')
...
names(NRMSEs_n01_smooth) = c('Cl', 'Cd', 'index')
...
for(j in 1:(nb_series)) {
  ...
  df_real = data.frame(time = seq(1,100,length=100), Coordinate = preds_n01[[4]][[j]]$Y[1:100],
                       Label = "Real")
  df_pred = data.frame(time = seq(1,100,length=100), Coordinate = preds_n01[[4]][[j]]$yh[1:100],
                       Label = "Predicted")
...
for(i in 1:nb_trials) {
  for(j in 1:nb_series) {
    NRMSE = nrmse(preds_n02[[i]][[j]]$yh, preds_n02[[i]][[j]]$Y, na.rm=TRUE, norm="sd")
...
names(NRMSEs_n02) = c('Cl', 'Cd', 'index')
...
names(NRMSEs_n02_smooth) = c('Cl', 'Cd', 'index')
...
for(j in 1:(nb_series)) {
  ...
  df_real = data.frame(time = seq(1,100,length=100), Coordinate = preds_n02[[1]][[j]]$Y[1:100], 
                       Label = "Real")
